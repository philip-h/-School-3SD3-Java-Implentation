...
public class Agatha extends Thread {
	...
	/*
	 * Parameters: Semaphore select: determines whether the agent should be
	 * selecting a new item or not Semaphore tabacco/paper/spark used to release
	 * the resources selected by the agent
	 */
	...
	public void run() {
		...
		while (true) {
			...
			if (select.tryAcquire()) {
				/*
				 * Generate a random number to see which two items should be
				 * released
				 */
